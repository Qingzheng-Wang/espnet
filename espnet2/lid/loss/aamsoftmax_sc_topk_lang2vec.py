...
class AAMSoftmaxSCTopKLang2Vec(AbsLoss):
    ...
    Args:
        ...
        NOTE(qingzheng):
        apply_last: used when use transformer_ecapa, which use lang2vec 
        self-condition on downstream transformer layers, since the lang2vec
        prediction loss has been applied to the downstream intermediate
        layers, the lang2vec prediction loss which was on the final layer
        ...
        cos(0.0) and sin_mp are sin(0.0). So, actually, I did not use
        the topK!!!

        But I set easy_margin to False, and use in all experiments. 
    """

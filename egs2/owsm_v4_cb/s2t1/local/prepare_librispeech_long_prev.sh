...
data_dir=/ocean/projects/cis210027p/qwang20/espnet_whisper/egs2/owsm_v4_cb/s2t1/downloads/LibriSpeech
prefix=LibriSpeech
output_dir=data/LibriSpeech_long_prev
splits="dev-clean dev-other train-clean-100 train-clean-360 train-other-500 test-clean test-other"

python local/prepare_librispeech_long_prev.py \
    --data_dir ${data_dir} \
    --prefix ${prefix} \

...
splits="librimix2_train librimix2_dev librimix2_test" 
...
# on spk2utt
kaldi_files="text_spk1 text_spk2"
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    log "Stage 1: LibriMix Data Preparation"
    bash local/osr/librimix_asr1_local/data.sh
    mv data/train data/librimix2_train
    mv data/dev data/librimix2_dev
    mv data/test data/librimix2_test
fi
